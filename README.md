...
| `MEGASERVEUR_DEFAULT_MODEL` | Optionnel — défaut `qwen2.5:1.5b` |
| `OPENROUTER_API_KEY` | Fallback si Megaserveur non configuré |

Dans l’app : **Réglages → Modèle principal** = `qwen2.5:1.5b` (pas besoin de clé OpenRouter si Megaserveur est côté serveur).
