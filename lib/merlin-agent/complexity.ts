...
const DEEP_PATTERNS = [
  /\b(pourquoi|comment|analyse|analyser|compare[rzs]?|comparons|comparer|explique|expliquer|réfléch|reflech|synthèse|synthese|plan|stratég|strateg|avis|recommand|pense|évalue|evalue|détail|detail|approfond|contexte)\b/i,
